---
title: "Cajal Papers — Draft and peer-review papers on a local Ollama model"
sidebar_label: "Cajal Papers"
...
Draft and peer-review papers on a local Ollama model.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/research/cajal-papers` |
| Path | `optional-skills/research/cajal-papers` |
| Version | `1.0.0` |
...
| Related skills | [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv), [`grounded-citations`](/docs/user-guide/skills/bundled/research/research-grounded-citations), [`research-paper-writing`](/docs/user-guide/skills/optional/research/research-research-paper-writing), [`pdf`](/docs/user-guide/skills/bundled/productivity/productivity-pdf) |
