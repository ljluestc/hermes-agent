---
title: "Agent Interop Osi — Map Agent OSI layers onto Hermes interop surfaces"
sidebar_label: "Agent Interop Osi"
...
Map Agent OSI layers onto Hermes interop surfaces.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/autonomous-ai-agents/agent-interop-osi` |
| Path | `optional-skills/autonomous-ai-agents/agent-interop-osi` |
| Version | `1.0.0` |
...
| Related skills | [`agent-merge-conflict-arbiter`](../../optional/autonomous-ai-agents/autonomous-ai-agents-agent-merge-conflict-arbiter.md), [`dynamic-workflow`](../../optional/autonomous-ai-agents/autonomous-ai-agents-dynamic-workflow.md) |
