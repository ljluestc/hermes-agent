...
from agent.prompt_builder import (
    ...
    PARALLEL_TOOL_CALL_GUIDANCE, PLATFORM_HINTS, PRIVILEGE_ESCALATION_GUIDANCE, SESSION_SEARCH_GUIDANCE,
...
def _tool_guidance_block(agent: Any) -> Optional[str]:
    ...
    tool_guidance = [
        ...
        _kanban_guidance,
        PRIVILEGE_ESCALATION_GUIDANCE if "terminal" in names else None,
    ]
